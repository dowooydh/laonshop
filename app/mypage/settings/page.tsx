...
const REGISTRATION_MESSAGES: Record<string, string> = {
  succeeded: "카드 등록이 완료되었습니다. 등록카드를 결제에 사용할 수 있습니다.",
  ...
  invalid: "등록 확인 정보가 만료되었거나 현재 계정의 요청과 일치하지 않습니다. 아래 ‘등록 절차 이어서 확인’을 눌러 기존 요청 상태를 먼저 확인해 주세요.",
  unavailable: "등록카드 연동이 준비되지 않아 카드 등록 결과를 반영하지 않았습니다.",
};
      ...
      <section id="billing-card-management" className="scroll-mt-24 space-y-5 border-t border-line pt-8">
        <div className="space-y-1">
          ...
          <p className="text-step--1 text-fg-subtle">
            등록카드 상태를 확인하거나 안전하게 해지할 수 있습니다.
          </p>
        </div>
        <BillingCards
